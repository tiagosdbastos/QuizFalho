    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when {
            score <= 40 -> {
                ...
                binding.layoutResultado.setBackgroundColor(Color.parseColor("#FFF3E0")) // Laranja fofo
            }
            score <= 70 -> {
                binding.txtEmoji.text = "🚀"
                ...
                binding.layoutResultado.setBackgroundColor(Color.parseColor("#E3F2FD")) // Azul fofo
            }
            else -> {
                binding.txtEmoji.text = "👑"
                binding.txtFeedback.text = "INCRÍVEL! Você brilhou muito! Seu desempenho foi nota dez, parabéns por todo esse conhecimento! 🏆"
                binding.layoutResultado.setBackgroundColor(Color.parseColor("#E8F5E9")) // Verde fofo
            }
        }
